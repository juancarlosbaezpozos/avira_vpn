...
namespace Avira.Common.Core
{
    internal class WinVerifyTrustNativeMethods
    {
        ...
        {
            private readonly AllocMethod allocMethod;
        ...
        internal static uint WinVerifyTrust(string fileName, ref int lastWin32Error)
        {
            ...
            using WINTRUST_DATA structure2 = new WINTRUST_DATA(fileInfo);
            ...
            uint num = WinVerifyTrust(IntPtr.Zero, intPtr, intPtr2);
            if (num != 0)
            {
