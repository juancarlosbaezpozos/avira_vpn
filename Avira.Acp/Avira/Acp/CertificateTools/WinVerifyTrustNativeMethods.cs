...
namespace Avira.Acp.CertificateTools
{
    internal class WinVerifyTrustNativeMethods
    {
        ...
        [SuppressMessage("Microsoft.Interoperability", "CA1404:CallGetLastErrorImmediatelyAfterPInvoke",
            Justification = "winVerifyTrustDelegate is a native call")]
            ...
            out int lastWin32Error, bool preventOnlineCheck)
        {
            ...
            using WINTRUST_DATA wINTRUST_DATA = new WINTRUST_DATA(fileInfo, preventOnlineCheck);
            ...
            Marshal.StructureToPtr(guid, intPtr, fDeleteOld: true);
            Marshal.StructureToPtr(wINTRUST_DATA, intPtr2, fDeleteOld: true);
